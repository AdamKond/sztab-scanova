// Budowa danych do odprawy — CZYSTA logika, bez dostępu do bazy i bez SDK.
// Wydzielona z lib/ai/briefing.ts, żeby dało się jej użyć także poza Next
// (skrypt scripts/odprawa.ts generuje odprawę przez subskrypcję w Claude Code,
// bez płatnego API).
//
// Zasada prywatności ze specyfikacji: do modelu NIE trafiają numery telefonów,
// prywatne e-maile, pełne notatki, sekrety ani dane klientów końcowych lokali.
...
export const BRIEFING_SYSTEM = `Jesteś doświadczonym szefem sprzedaży w SCANOVIE — polskim systemie
