...
import { listActivities, listDmBlitz, listLeads, listStageHistory } from "@/lib/crm/queries";
import { warsawToday } from "@/lib/crm/dates";

// Eksport danych do CSV. Route handler zamiast server action, żeby przeglądarka
// dostała zwykły plik do pobrania. Autoryzacja jak wszędzie: brak dostępu = 404.
...
export async function GET(_request: NextRequest, { params }: { params: Promise<{ zbior: string }> }) {
